...
N = 256  # size of the lattice, N x N
eqSteps = 20  # number of MC sweeps for equilibration
mcSteps = 20  # number of MC sweeps for calculation

T = np.flip(np.linspace(0.5, 2, nt))
...
np.save("results/test_run_1.npy", layers)
fast_animate_run(layers, fastest=True, resize=False, size=(
    512, 512), filepath="Figures/Ising1/", filename="test_run")
